	...
	var UtilsCookie = {
	  ...
	  setCookie: function setCookie(that, cookieName, cookieValue) {
	    ...
	    switch (that.options.cookieStorage) {
	      case 'cookieStorage':
	        document.cookie = [cookieName, '=', encodeURIComponent(cookieValue), "; expires=".concat(UtilsCookie.calculateExpiration(that.options.cookieExpire)), that.options.cookiePath ? "; path=".concat(that.options.cookiePath) : '', that.options.cookieDomain ? "; document=".concat(that.options.cookieDomain) : '', that.options.cookieSecure ? '; secure' : ''].join('');
	        break;
	  ...
	  deleteCookie: function deleteCookie(that, tableName, cookieName) {
	    ...
	    switch (that.options.cookieStorage) {
	      case 'cookieStorage':
	        document.cookie = [encodeURIComponent(cookieName), '=', '; expires=Thu, 01 Jan 1970 00:00:00 GMT', that.options.cookiePath ? "; path=".concat(that.options.cookiePath) : '', that.options.cookieDomain ? "; document=".concat(that.options.cookieDomain) : ''].join('');
	        break;
