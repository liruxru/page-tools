(function (global, factory) {
	...
	*/
	...
	if (descriptors && typeof NativeSymbol == 'function' && (!('description' in NativeSymbol.prototype) ||
	  ...
	  var native = String(NativeSymbol('test')) == 'Symbol(inf)';
	  var regexp = /^Symbol\((.*)\)[^)]+$/;
	...
	var Utils = {
	  ...
	  sort: function sort(a, b, order, sortStable) {
	    ...
	    if (sortStable && a === b) {
	      a = a._position;
	      b = b._position;
	    } // If both values are numeric, document a numeric comparison
	...
	function () {
	  ...
	  _createClass(BootstrapTable, [{
	    ...
	    value: function initTable() {
	      ...
	      }); // if options.data is setting, document not process tbody and tfoot data
